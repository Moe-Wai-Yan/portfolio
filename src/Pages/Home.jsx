...
const StatusBadge = memo(() => (
  <div className="inline-block animate-float lg:mx-0" data-aos="zoom-in" data-aos-delay="400">
    <div className="relative group">
      ...
      <div className="relative mt-20 px-3 sm:px-4 py-2 rounded-full bg-black/40 backdrop-blur-xl border border-white/10">
...
const TECH_STACK = ["Laravel", "Javascript", "PHP", "Tailwind", "Vue.js", "Livewire", "Alpine.js", "React.js"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Moe-Wai-Yan" },
  { icon: Mail, link: "mailto:moorewaiyan@gmail.com" },
  // { icon: Telegram, link: "https://t.me/phonehtutkhaung" }
];
